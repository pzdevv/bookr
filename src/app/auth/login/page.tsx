...
export default function LoginPage() {
    ...
    return (
        ...
        >
            {/* Background Blurs */}
            <div className="fixed top-[-20%] right-[-10%] w-[600px] h-[600px] bg-[#850000]/5 rounded-full blur-[120px] -z-10"></div>
            <div className="fixed bottom-[-10%] left-[-5%] w-[400px] h-[400px] bg-[#850000]/10 rounded-full blur-[100px] -z-10"></div>

            {/* Geometric Shapes */}
            <div className="absolute top-[15%] left-[10%] pointer-events-none opacity-[0.03] text-[#850000]">
            ...
            <div className="absolute bottom-[10%] right-[5%] pointer-events-none opacity-[0.03] text-[#850000]">
                    ...
                    >
                        ...
                        <div className="lg:w-7/12 p-12 lg:p-16 flex flex-col justify-center">
                            <div className="max-w-md mx-auto w-full">
                                <div className="mb-10">
                                    <h1 className="text-3xl font-extrabold text-[#1d0c0c] tracking-tight mb-2">Sign in to your account</h1>
                                    <p className="text-[#6b4444]">Access your scheduling dashboard.</p>
                                </div>
                                ...
                                <form className="space-y-6" onSubmit={handleSubmit}>
                                    ...
                                    <div className="relative flex items-center py-2">
                                        <div className="flex-grow" style={{ borderTop: '1px solid rgba(0, 0, 0, 0.05)' }}></div>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="auth-input flex flex-col gap-1.5">
                                            <div className="flex justify-between items-center ml-1">
                                                <label htmlFor="password" className="text-xs font-bold text-[#1d0c0c] uppercase tracking-wider">Password</label>
                                                <Link className="text-xs font-semibold text-[#850000] hover:text-[#6b0000] transition-colors" href="/auth/forgot-password">Forgot password?</Link>
                                            </div>
                                    ...
                                    <div className="pt-4">
                                        <button
                                            className="auth-btn w-full h-14 bg-[#850000] text-white font-extrabold rounded-lg hover:bg-[#4d0000] transition-all transform hover:-translate-y-0.5 active:translate-y-0 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:translate-y-0"
                                        ...
                                        {/* Sign Up Link */}
                                        <p className="text-center text-sm text-[#a14545] mt-6">
                                            Don't have an account? <Link className="font-bold text-[#1d0c0c] hover:text-[#850000] transition-colors" href="/auth/signup">Sign up free</Link>
                                        </p>
                                    </div>
                                </form>
                            </div>
